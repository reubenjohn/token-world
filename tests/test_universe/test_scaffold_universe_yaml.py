...
class TestScaffoldUniverseYaml:
    ...
    def test_rerscaffold_does_not_overwrite_universe_yaml(self, tmp_data_dir: Path) -> None:
        ...
        original_content = (universe_dir / "universe.yaml").read_text(encoding="utf-8")
        ...
        if not yaml_path.exists():
            yaml_path.write_text(render_universe_yaml(universe_seed=generate_universe_seed()), encoding="utf-8")
